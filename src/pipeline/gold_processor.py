...
def process_gold():
    print(">>> [Phase 4] Gold Processor (Final Optimized)")
    ...
    for key in pbar:
        ...
        if n_total > MAX_BUCKET_SIZE:
            # 1.정상가격(동전주X) 2.최신거래 3.데이터길이 순 정렬
    ...
    print(f"  ✅ Gold 완료 (저장: {success_cnt}, 병합: {dedup_cnt})")
