...
# ==========================================
# [Script 04] Gold Layer 생성 (Final Logic Sync)
# ==========================================
...
def calculate_correlation_optimized(meta_a, meta_b, window=120):
    # [Anomaly 대응] Penny Stock Filter: 둘 다 동전주면 비교 가치 없음
    ...
    # [중요 변경] Price Filter 제거
    # 이유: 액면분할(1/10) 등으로 가격 차이가 커도 상관계수는 높을 수 있음.
    # Stitching 단계에서 Ratio Adjusting으로 해결.
...
def main():
    print(">>> [Script 04] Gold Layer 생성 (Final Logic Sync)")
